...
export default function index(){
    // Hooks para manipulação de variáveis e estados
    ...
    return(
        <View style={styles.form}>
            <View>
                ...
                <TextInput style={styles.input} onChangeText={setMediaEtapa1}></TextInput>
            </View>

            <View>
                <Text style={styles.label}>Média etapa 2</Text>
                <TextInput style={styles.input} onChangeText={setMediaEtapa2}></TextInput>
            </View>

            <TouchableOpacity style={styles.btn} onPress={() => calcularMedia()}>
